...
#ifndef LYRA_CODEC_PREPROCESSOR_INTERFACE_H_
#define LYRA_CODEC_PREPROCESSOR_INTERFACE_H_
...
// An interface to preprocess audio.
...
#endif  // LYRA_CODEC_PREPROCESSOR_INTERFACE_H_
